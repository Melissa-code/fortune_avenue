...
const effetsChanceJson = [
    ...
    {
        "titre": "Chance 3",
        "description": `Rendez-vous à l’Avenue Henri-Martin.\nSi vous passez par la case départ, recevez 200 M.`,
        "type": TypesEffets.DEPLACEMENT,
        "type_deplacement": "absolu",
        "index_case": 24,
        "nombreDePas": 0,
    ...
    {
        "titre": "Chance 4",
        "description": `Avancez au Boulevard de La Villette.\nSi vous passez par la case départ, recevez 200 M.`,
        "type": TypesEffets.DEPLACEMENT,
        "type_deplacement": "absolu",
        "index_case": 11,
        "nombreDePas": 0,
    ...
    {
        "titre": "Chance 5",
        "description": `Vous êtes imposé pour les réparations de voirie à raison\nde 40 M par maison et 115 M par hôtel.`,
    ...
    {
        "titre": "Chance 6",
        "description": `Avancez jusqu’à la Gare de Lyon.\nSi vous passez par la case départ, recevez 200 M.`,
        "type": TypesEffets.DEPLACEMENT,
        "type_deplacement": "absolu",
        "index_case": 15,
        "nombreDePas": 0,
    ...
    {
        "titre": "Chance 12",
        "description": `Vous faites des réparations.\nVersez pour chaque maison 25 M et pour chaque hôtel 100 M.`,
        "type": TypesEffets.REPARATIONS, 
