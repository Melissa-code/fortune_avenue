...
export class CaseJeuFactory {
  ...
  static generateCase(jsonObj) {
    switch (jsonObj.type) {
      ...
      default: {
        // {} pour décl nvlle variable (ex : caseAction dans le scope du switch)
        ...
        switch (jsonObj.type) {
          ...
          case TypesCases.DEPART:
            caseAction.ajouterEffet(
              new VersementEffet(200, "banque", "joueur"),
            );
            break;
          ...
          case TypesCases.TAXE: {
            ...
            caseAction.ajouterEffet(
              new VersementEffet(montant, "joueur", "banque"),
            );
            break;
          }
